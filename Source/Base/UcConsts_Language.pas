...
const
  ...
  {$ENDIF}  
    ...
    ('Const_LogC_LabelDetail', 'Mensagem completa'),
    ('Const_LogC_BtCopy', 'Copiar mensagem'),
    ...
    ('Const_Inc_BtLoadImage', 'Carregar'),
    ('Const_Inc_BtRemoveImage', 'Remover'),
    ...
    ('Const_Perm_SearchLabel', 'Localizar:'),
    ('Const_Perm_SearchNext', 'Próximo'),
    ('Const_Perm_SearchNoResults', 'Nenhuma permissão encontrada'),
    ('Const_Perm_SearchInherited', 'Herdado do perfil')
  );
...
const
  UC_ENGLISH: Array [0 .. MaxArray, 0 .. 1] of string = (
    ...
    ('Const_LogC_LabelDetail', 'Full message'),
    ('Const_LogC_BtCopy', 'Copy message'),
    ...
    ('Const_Inc_BtLoadImage', 'Load'),
    ('Const_Inc_BtRemoveImage', 'Remove'),
    ...
    ('Const_Perm_SearchLabel', 'Find:'),
    ('Const_Perm_SearchNext', 'Next'),
    ('Const_Perm_SearchNoResults', 'No permissions found'),
    ('Const_Perm_SearchInherited', 'Inherited from profile')
  );
...
const
  UC_SPANISH: Array [0 .. MaxArray, 0 .. 1] of string = (
    ...
    ('Const_LogC_LabelDetail', 'Mensaje completo'),
    ('Const_LogC_BtCopy', 'Copiar mensaje'),
    ...
    ('Const_Inc_BtLoadImage', 'Cargar'),
    ('Const_Inc_BtRemoveImage', 'Eliminar'),
    ('Const_Cad_BtApplyFilter', 'Aplicar filtro'),
    ...
    ('Const_Perm_SearchLabel', 'Buscar:'),
    ('Const_Perm_SearchNext', 'Siguiente'),
    ('Const_Perm_SearchNoResults', 'No se encontraron permisos'),
    ('Const_Perm_SearchInherited', 'Heredado del perfil')
  );
...
const
  UC_FRENCH: Array [0 .. MaxArray, 0 .. 1] of string = (
    ...
    ('Const_LogC_LabelDetail', 'Message complet'),
    ('Const_LogC_BtCopy', 'Copier le message'),
    ...
    ('Const_Inc_BtLoadImage', 'Charger'),
    ('Const_Inc_BtRemoveImage', 'Supprimer'),
    ...
    ('Const_Men_Select_Profile', 'Por favor seleccione el perfil!'),
    ('Const_Err_Image_Too_Large', 'Imagen debe ser menor que %s bytes'),
    ('Const_Perm_SearchLabel', 'Rechercher :'),
    ('Const_Perm_SearchNext', 'Suivant'),
    ('Const_Perm_SearchNoResults', 'Aucune autorisation trouvée'),
    ('Const_Perm_SearchInherited', 'Héritée du profil')
  );

Function RetornaLingua(Lingua: TUCLanguage; Prop: String): String;
function GetTranslate(const Language: TUCLanguage; const Value, Prop: string): string;
...
begin
  Result := Value;
  if Result = '' then
    Result := RetornaLingua(Language, Prop);
end;
